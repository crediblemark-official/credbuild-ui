        ...
        <div className="flex flex-col gap-1.5">
            ...
            {isRowLayout ? (
                ...
                <div 
                    ...
                    onClick={() => !disabled && setIsOpen(true)}
                    onKeyDown={handleKeyDownTrigger}
                    className={`group relative overflow-hidden transition-all border border-dashed border-border rounded-lg bg-muted/20 shadow-sm focus-visible:ring-2 focus-visible:ring-primary/20 focus-visible:border-primary/50 outline-none
                        ${disabled ? "cursor-not-allowed opacity-50" : "cursor-pointer hover:border-primary/50"}
                        ${variant === 'compact' ? 'h-16 w-full' : 'aspect-video w-full'}
                    `}
                >
                    {value ? (
                        <>
                        ...
                        <div className="absolute inset-0 flex flex-col items-center justify-center gap-1.5 opacity-40 group-hover:opacity-100 transition-opacity">
                            <ImageIcon size={variant === 'compact' ? 16 : 24} />
